...
func NewDispatcher(rootCtx context.Context, configDB Store, bus Bus) *Dispatcher {
	if rootCtx == nil {
...
func (d *Dispatcher) publishOne(ctx context.Context, item domain.TopicEventRecord, claimID string) bool {
