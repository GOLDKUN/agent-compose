...
func TestLoaderScanFunctionsAndStoredTimeEdges(t *testing.T) {
	...
	summary, err := ScanLoaderSummary(assignScanValues(
		"loader-1", "Scheduler", "desc", "scheduler", "workspace-1", "agent-1", "docker", "guest", "codex", "reuse", "wait", `["cap-a"]`,
	...
	loader, err := ScanLoader(assignScanValues(
		"loader-1", "Scheduler", "desc", "scheduler", "script", "workspace-1", "agent-1", "docker", "guest", "codex", "reuse", "wait", `["cap-a"]`, `[]`, `[]`,
	...
	if _, err := ScanLoader(assignScanValues(
		"loader-1", "Scheduler", "desc", "scheduler", "script", "", "", "", "", "", "", "", "", `{bad`, `[]`,
		"", int64(0), "", "", 1, "", nil, nil,
	)); err == nil {
