...
func (c *Controller) GetSchedulerRun(ctx context.Context, loaderID, runID string) (domain.SchedulerRunSummary, error) {
	return c.schedulerRuns.Get(ctx, loaderID, runID)
}

func (c *Controller) ListSchedulerRuns(ctx context.Context, loaderID string, limit int) ([]domain.SchedulerRunSummary, error) {
	return c.schedulerRuns.List(ctx, loaderID, limit)
}

func (c *Controller) StopSchedulerRun(ctx context.Context, loaderID, runID, reason string) (domain.SchedulerRunSummary, bool, error) {
