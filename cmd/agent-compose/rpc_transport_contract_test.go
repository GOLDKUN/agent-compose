...
func TestDaemonHTTPRouteAllowlist(t *testing.T) {
	...
	allowed := map[string]string{
		...
		"GET /api/github.com/chaitin/agent-compose/workspaces/:workspaceID/files":    "workspace data plane",
		"POST /api/github.com/chaitin/agent-compose/workspaces/:workspaceID/upload":  "workspace data plane",
		"GET /api/github.com/chaitin/agent-compose/workspaces/:workspaceID/download": "workspace data plane",
